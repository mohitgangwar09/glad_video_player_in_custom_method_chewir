    ...
    return Column(
      children: [
        ...
        CarouselSlider(
            items: [
              weatherWidget(),
              if(context.read<AuthCubit>().sharedPreferences.getString(AppConstants.userType)! != "mcc")
              InkWell(
                onTap: () {
        ...
        Center(
          child: Padding(
            ...
            child: AnimatedSmoothIndicator(
              ...
              count: context.read<AuthCubit>().sharedPreferences.getString(AppConstants.userType)!  != 'mcc' ?3 : 2,

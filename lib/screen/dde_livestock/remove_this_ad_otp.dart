...
class AddMarkAsDeliveryRemove extends StatefulWidget {
  final User projectData;
  final int id;
  final String? quantity;
  final String updateSoldQtyTag;

  const AddMarkAsDeliveryRemove({super.key,required this.projectData,required this.id,this.quantity,required this.updateSoldQtyTag});

  @override
  State<AddMarkAsDeliveryRemove> createState() => _AddMarkAsDeliveryRemoveState();
}

class _AddMarkAsDeliveryRemoveState extends State<AddMarkAsDeliveryRemove> {

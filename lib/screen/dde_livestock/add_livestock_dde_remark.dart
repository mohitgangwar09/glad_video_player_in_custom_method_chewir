...
class AddDdeLivestockRemarks extends StatefulWidget {
  const AddDdeLivestockRemarks({super.key,
  ...
  final String milk, price,lactation,pregnant,quantity,age,controller;
  final List<String> path;


  @override
  State<AddDdeLivestockRemarks> createState() => _AddDdeLivestockRemarksState();
}

class _AddDdeLivestockRemarksState extends State<AddDdeLivestockRemarks> {
  ...
  Widget remarkOtp(LivestockCubitState state) {
    return Column(
      children: [
        Row(
        ...
        customButton('Send OTP', fontColor: 0xffFFFFFF,
            onTap: istClickOnSendOtp == ""?() {
              ...
              BlocProvider.of<ProjectCubit>(context).sendProjectStatusOtpApi(context,
                  state.selectedLivestockFarmerMAster!.phone.toString()
              );
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    state.selectedLivestockFarmerMAster!.photo!=null?
                    CircleAvatar(
                        radius: 33,
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(40),
                          child: CachedNetworkImage(
                            imageUrl: state.selectedLivestockFarmerMAster!.photo??'',
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(state.selectedLivestockFarmerMAster!.name.toString()??'',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(state.selectedLivestockFarmerMAster!.phone.toString() ?? '',
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: MediaQuery.of(context).size.width *
                                  0.5,
                              child: Text(state.selectedLivestockFarmerMAster!.address!=null?
                              state.selectedLivestockFarmerMAster!.address!.address!=null ?state.selectedLivestockFarmerMAster!.address!.address!.toString():"":"",
                                maxLines: 1,
  ...
  // main View
  Widget mainView(LivestockCubitState state) {
    return Column(
      children: [
        30.verticalSpace(),
        Text(
  ...
  // pinFieldController
  Widget pinFieldController(context,LivestockCubitState state) {
    return Padding(

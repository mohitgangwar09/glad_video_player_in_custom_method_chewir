...
import 'package:glad/screen/farmer_screen/project_farmer_statment.dart';
...
class CustomLoanFarmerDetail extends StatefulWidget {
  const CustomLoanFarmerDetail({super.key, required this.projectId});
  final int projectId;

  @override
  State<CustomLoanFarmerDetail> createState() =>
      _CustomLoanFarmerDetailState();
}

class _CustomLoanFarmerDetailState extends State<CustomLoanFarmerDetail> {
                  ...
                  child: InkWell(
                    onTap: ()async{
                      ...
                      FirebaseFirestore.instance.collection('projects_chats')
                        ...
                        'project_image': state.responseFarmerProjectDetail!.data!.farmerProject![0].improvementArea!=null?state.responseFarmerProjectDetail!.data!.farmerProject![0].improvementArea!.image.toString():'',
                      ...
                      ResponseProjectDataForFirebase response = ResponseProjectDataForFirebase(
                          ...
                          projectImage: state.responseFarmerProjectDetail!.data!
                              .farmerProject![0].improvementArea!=null?state.responseFarmerProjectDetail!.data!.farmerProject![0].improvementArea!.image
                              .toString():"");

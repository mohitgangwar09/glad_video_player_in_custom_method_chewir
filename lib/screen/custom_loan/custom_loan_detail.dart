...
class CustomLoanDetail extends StatefulWidget {
  const CustomLoanDetail({
    super.key,
  ...
  @override
  State<CustomLoanDetail> createState() =>
      _CustomLoanDetailState();
}

class _CustomLoanDetailState
    extends State<CustomLoanDetail> {
                    ...
                    onTap: () async {
                      FirebaseFirestore.instance
                        ...
                        'project_image': state.responseFarmerProjectDetail!.data!
                            .farmerProject![0].improvementArea!=null?state.responseFarmerProjectDetail!.data!
                            .farmerProject![0].improvementArea!.image
                            .toString():'',

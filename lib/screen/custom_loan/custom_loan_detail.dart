...
class CustomLoanDetail extends StatefulWidget {
  const CustomLoanDetail({super.key, required this.id});
  final int id;

  @override
  State<CustomLoanDetail> createState() => _CustomLoanDetailState();
}

class _CustomLoanDetailState extends State<CustomLoanDetail> {

  @override
  void initState() {
    BlocProvider.of<ProjectCubit>(context)
        .farmerProjectDetailApi(context, widget.id);
    super.initState();
  }

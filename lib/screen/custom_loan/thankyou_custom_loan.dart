...
class ThankYouCustomLoan extends StatelessWidget {
  const ThankYouCustomLoan({super.key, required this.response});
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                40.verticalSpace(),
                // response!=null?
                BlocProvider.of<AuthCubit>(context).sharedPreferences.getString(AppConstants.userType).toString() != "dde" ? profileDataWidget(context) : ddeFarmerProfileDataWidget(context),
                ...
                customButton("Back", fontColor: 0xffffffff, onTap: () {
                  ...
                  //   const CustomLoanList(navigateFrom:"na").navigate();
                  // }else{
  ...
  Widget ddeFarmerProfileDataWidget(context){
    return Padding(
      padding: const EdgeInsets.fromLTRB(0.0, 20, 10, 20),
      child: Container(
        decoration: BoxDecoration(
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                response!.photo!=null?
                networkImage(text: response!.photo!,height: 46,width: 46,radius: 40):
                Image.asset(Images.sampleUser),
                10.horizontalSpace(),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Text(response!.name!=null?response!.name!.toString():'',
                        style: figtreeMedium.copyWith(
                            fontSize: 16, color: Colors.black)),
                    4.verticalSpace(),
                    Text('+256 ${response!.phone!=null?response!.phone!.toString():''}',
                        style: figtreeRegular.copyWith(
                            fontSize: 14, color: Colors.black)),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(
                          width: MediaQuery.of(context).size.width *
                              0.5,
                          child: Text(response!.address!=null?response!.address!.address ?? '':"",
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: figtreeRegular.copyWith(
                              fontSize: 12,

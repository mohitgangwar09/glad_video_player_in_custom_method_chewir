...
class AddCustomLoanRemark extends StatefulWidget {
...
class _AddCustomLoanRemarkState extends State<AddCustomLoanRemark> {
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: MediaQuery.of(context).size.width *
                                  0.5,
                              child: Text(widget.projectData!.address!=null?widget.projectData!.address!.address ?? '':"",
                                maxLines: 1,

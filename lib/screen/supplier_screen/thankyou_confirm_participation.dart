...
class ThankYouConfirm extends StatelessWidget {
  const ThankYouConfirm({super.key ,this.profileData,this.projectStatus});
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                10.verticalSpace(),
                Text(
                    'The payment against Farmer Participation has been marked as received.',
                ...
                Text(
                    'You can track the status of your application from project section.',
                    textAlign: TextAlign.center,
                    style: figtreeRegular.copyWith(fontSize: 14,color: ColorResources.black,)),

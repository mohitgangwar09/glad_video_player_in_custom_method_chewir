...
class SupplierFarmerDetail extends StatefulWidget {
  const SupplierFarmerDetail({Key? key, required this.userId,required this.farmerId}) : super(key: key);
  final int userId,farmerId;

  @override
  State<SupplierFarmerDetail> createState() => _SupplierFarmerDetailState();
}

class _SupplierFarmerDetailState extends State<SupplierFarmerDetail> {

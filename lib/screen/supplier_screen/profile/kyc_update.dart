...
class _KYCUpdateState extends State<KYCUpdate> {
  ...
  String type = 'company';
  String docOne= 'Document 1';
  String docTwo= 'Document 2';
  String docThree= 'Document 3';
  String docFour= 'Document 4';
  String docFive= 'Document 5';
  String docSix= 'Document 6';
                            ...
                            child: customButton(
                              ...
                              onTap: () {
                                if(docOneFile.isEmpty) {
                                  showCustomToast(
                                      context, 'Please upload document 1');
                                }else if(docTwoFile.isEmpty){
                                  showCustomToast(
                                      context, 'Please upload document 2');
                                }else if(docThreeFile.isEmpty){
                                  showCustomToast(
                                      context, 'Please upload document 3');
                                }else if(docFourFile.isEmpty){
                                  showCustomToast(
                                      context, 'Please upload document 4');
                                }else if(docFiveFile.isEmpty){
                                  showCustomToast(
                                      context, 'Please upload document 5');
                                }else if(docSixFile.isEmpty){
                                  showCustomToast(
                                      context, 'Please upload document 6');
                                }else{

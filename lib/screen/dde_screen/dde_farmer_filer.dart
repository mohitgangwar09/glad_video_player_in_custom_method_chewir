...
class FilterDDEFarmer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(preferredSize: const Size(0,0),
      child: AppBar(
        elevation: 0,
        backgroundColor: Colors.white,
      )),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              "Filters".textMedium(fontSize: 22),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      children: ["Water Management", "pasture & Fodder","Medicine & Vaccination",].map((item) =>
                          Container(
                              margin: 5.marginAll(),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        "Numbers".textSemiBold(fontSize: 12,color: const Color(0xff727272))
                      ],
                    ),

                    customProjectContainer(marginLeft: 0,marginTop: 8,height: 124,
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ),height:50,child: const TextField(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  "UpTo".textSemiBold(fontSize: 14,),

                                   Container(
                                       padding: const EdgeInsets.only(left: 10),
                                       margin: const EdgeInsets.only(top: 5),decoration: boxDecoration(
                                       borderRadius: 10,
                                       borderColor: const Color(0xff767676)
                                   ),height:50,child: const TextField(
                                    decoration: InputDecoration(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        "In litre".textSemiBold(fontSize: 12,color: const Color(0xff727272))
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        "In Acres".textSemiBold(fontSize: 12,color: const Color(0xff727272))
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        "In Numbers".textSemiBold(fontSize: 12,color: const Color(0xff727272))
                      ],
                    ),
                    ...
                    Wrap(
                      children: ["Friesian", "Ankole","Ankole","Frin",].map((item) =>
                          Container(
                              margin: 5.marginAll(),
                              padding: const EdgeInsets.only(left: 14,right: 14,bottom: 10,top: 10),
                              decoration:boxDecoration(

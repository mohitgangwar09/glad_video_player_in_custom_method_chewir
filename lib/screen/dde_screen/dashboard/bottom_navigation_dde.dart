...
class BottomNavigationDDEScreen extends StatefulWidget {
  const BottomNavigationDDEScreen({Key? key}) : super(key: key);

  @override
  State<BottomNavigationDDEScreen> createState() => _BottomNavigationDDEScreenState();
}

class _BottomNavigationDDEScreenState extends State<BottomNavigationDDEScreen> {

...
class DdeEarningDetails extends StatefulWidget {
  const DdeEarningDetails({super.key});

  @override
  State<DdeEarningDetails> createState() => _DdeEarningDetailsState();
}

class _DdeEarningDetailsState extends State<DdeEarningDetails> {

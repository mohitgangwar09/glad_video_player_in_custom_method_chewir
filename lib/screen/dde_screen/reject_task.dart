...
class RejectTaskDDE extends StatefulWidget {
  farmer.FarmerMaster projectData;
  final int farmerProjectId;
  final FarmerProjectTask task;

  RejectTaskDDE({super.key,required this.projectData,required this.farmerProjectId, required this.task});

  @override
  State<RejectTaskDDE> createState() => _RejectTaskDDEDDEState();
}

class _RejectTaskDDEDDEState extends State<RejectTaskDDE> {

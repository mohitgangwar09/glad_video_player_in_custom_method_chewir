              ...
              children: [
                ...
                Stack(
                  children: [
                    ...
                    Positioned.fill(
                      child: Center(child:"Farmers".textMedium(fontSize: 22)),
                    ),
                  ],
                ),
                ...
                Container(
                  margin: const EdgeInsets.only(left: 20,right: 20,bottom: 13,top: 23),
                  height: 50,
                ...
                Container(
                  margin: const EdgeInsets.only(left: 18,right: 7,bottom: 20,top: 10),
                  height: 36,
                  child: customList(axis: Axis.horizontal,child: (int index){
                    return Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          "04".textSemiBold(fontSize: 12,color: const Color(0xffFC5E60)),
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: customList(child: (int i) {
                      return Padding(
                        padding: const EdgeInsets.only(left: 10,right: 20,bottom: 12),
                        child: Stack(
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 12.0,right: 22,top: 18),
                                      child: Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          ...
                                          Text.rich(
                                            TextSpan(
                                              children: [
                                                TextSpan(text: 'Farm: ',style: figtreeRegular.copyWith(
                                          ...
                                          Text.rich(
                                            TextSpan(
                                              children: [
                                                TextSpan(text: 'Milking/Cows: ',style: figtreeRegular.copyWith(
                                                    color: const Color(0xff808080),
                                                    fontSize: 12
                                                )),
                                                TextSpan(
                                          ...
                                          Text.rich(
                                            TextSpan(
                                              children: [
                                                TextSpan(text: 'Yield/Cow: ',style: figtreeRegular.copyWith(
                                                    color: const Color(0xff808080),
                                                    fontSize: 12
                                                )),
                                                TextSpan(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              "Dam Construction".textMedium(fontSize: 12),

              ...
              state.responseDdeProject!.data!.projectList!.isNotEmpty
                  ? Expanded(
                      child: SingleChildScrollView(
                        ...
                        child: customList(
                            list: List.generate(state.responseDdeProject!.data!.projectList!.length, (index) => null),
                            child: (int i) {
                              return Padding(
                                ...
                                child: customProjectContainer(
                                    child: ProjectWidget(
                                      status: true,
                                      projectStatus: state.responseDdeProject!.data!.projectList![i].projectStatus ?? '',
                                      name: state.responseDdeProject!.data!.projectList![i].name ?? '',
                                      category: state.responseDdeProject!.data!.projectList![i].farmerImprovementArea != null ? state.responseDdeProject!.data!.projectList![i].farmerImprovementArea!.improvementArea!.name ?? '' : '',
                                      description: state.responseDdeProject!.data!.projectList![i].description ?? '',
                                      investment: state.responseDdeProject!.data!.projectList![i].investmentAmount ?? 0,
                                      revenue: state.responseDdeProject!.data!.projectList![i].revenuePerYear ?? 0,
                                      roi: state.responseDdeProject!.data!.projectList![i].roiPerYear ?? 0,
                                      loan: state.responseDdeProject!.data!.projectList![i].loanAmount ?? 0,
                                      emi: state.responseDdeProject!.data!.projectList![i].emiAmount ?? 0,
                                      balance: 0,
                                      farmerName: state.responseDdeProject!.data!.projectList![i].farmerMaster!.name ?? '',
                                      farmerAddress: state.responseDdeProject!.data!.projectList![i].farmerMaster!.fAddress ?? '',
                                      farmerImage: state.responseDdeProject!.data!.projectList![i].farmerMaster!.photo ?? '',
                                      farmerPhone: state.responseDdeProject!.data!.projectList![i].farmerMaster!.phone ?? '',
                                      projectPercent: 0,
                                    ),
                                    width: screenWidth()),
                              );

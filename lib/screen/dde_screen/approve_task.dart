...
class ApproveTaskDDE extends StatefulWidget {
  farmer.FarmerMaster projectData;
  final int farmerProjectId;
  final FarmerProjectTask task;
  
  ApproveTaskDDE({super.key,required this.projectData,required this.farmerProjectId, required this.task});

  @override
  State<ApproveTaskDDE> createState() => _ApproveTaskDDEState();
}

class _ApproveTaskDDEState extends State<ApproveTaskDDE> {

...
class AddRemarkRevoke extends StatefulWidget {
  FarmerMaster projectData;
  final int farmerProjectId;
  AddRemarkRevoke({super.key,required this.projectData,required this.farmerProjectId});

  @override
  State<AddRemarkRevoke> createState() => _AddRemarkRevokeState();
}

class _AddRemarkRevokeState extends State<AddRemarkRevoke> {

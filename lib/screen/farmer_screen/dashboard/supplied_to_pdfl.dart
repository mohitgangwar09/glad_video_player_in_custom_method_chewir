                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    MainAxisAlignment
                                        .spaceBetween,
                                    children: [
                                      '${state.milkProductionChartResponse!.data!.lastWeekData![index].suppliedToPdfl ?? 0} Litre'
                                          .textMedium(
                                          color: Colors.black,
                                          fontSize: 18),
                                      DateFormat('dd MMMM, yyyy')
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    MainAxisAlignment
                                        .spaceBetween,
                                    children: [
                                      '${state.milkProductionChartResponse!.data!.previousDay![index].suppliedToPdfl ?? 0} Litre'
                                          .textMedium(
                                          color: Colors.black,
                                          fontSize: 18),
                                      DateFormat('dd MMMM, yyyy')

...
import 'package:glad/screen/common/add_livestock_remark.dart';
...
class LivestockKyc extends StatefulWidget {
  const LivestockKyc({super.key,required this.id,required this.farmerParticipation,required this.farmerMaster});
  ...
  @override
  State<LivestockKyc> createState() => _LivestockKycState();
}

class _LivestockKycState extends State<LivestockKyc> {
                        ...
                        child: customButton(
                          ...
                          onTap: () {
                            ...
                            if (profilePicture.isEmpty) {
                              ...
                              AddLivestokcLoanRemark(widget.id, widget.farmerParticipation.toString(), "remarks",
                                ...
                                idDate.text,
                                idImg,
                                profilePicture,widget.farmerMaster).navigate();

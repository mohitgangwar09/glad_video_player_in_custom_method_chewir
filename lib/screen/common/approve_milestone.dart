...
import '../../../data/model/farmer_project_detail_model.dart' as farmer;


class ApproveMilestone extends StatefulWidget {
  farmer.FarmerMaster projectData;
  final int farmerProjectId;
  final MilestoneDetails milestone;

  ApproveMilestone({super.key,required this.projectData,required this.farmerProjectId, required this.milestone});

  @override
  State<ApproveMilestone> createState() => _ApproveMilestoneState();
}

class _ApproveMilestoneState extends State<ApproveMilestone> {
            ...
            onChanged: (value) {
              if(value.length == 4){
                BlocProvider.of<ProjectCubit>(context)
                    ...
                    context,
                    widget.milestone.farmerId,
                    widget.milestone.farmerProjectId,
                    widget.milestone.id,
                    'approved', controller.text, value.toString());
              }

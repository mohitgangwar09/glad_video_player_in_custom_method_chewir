...
class AddRemarkDisputeScreen extends StatefulWidget {
  final FarmerProject project;
  final int farmerProjectId;

  AddRemarkDisputeScreen({super.key,required this.project,required this.farmerProjectId});

  @override
  State<AddRemarkDisputeScreen> createState() => _AddRemarkDisputeScreenState();
}

class _AddRemarkDisputeScreenState extends State<AddRemarkDisputeScreen> {
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(context.read<ProjectCubit>().state.responseFarmerProjectDetail!.data!.supplierDetail!.name ?? '',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(context.read<ProjectCubit>().state.responseFarmerProjectDetail!.data!.supplierDetail!.phone ?? '',
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: MediaQuery.of(context).size.width *
                                  0.5,
                              child: Text(context.read<ProjectCubit>().state.responseFarmerProjectDetail!.data!.supplierDetail!.address!=null?
                              context.read<ProjectCubit>().state.responseFarmerProjectDetail!.data!.supplierDetail!.address["address"] ??  "":"",
                                maxLines: 1,
            ...
            child: Column(
              children: [
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    widget.project.farmerMaster!.photo!=null?
                    CircleAvatar(
                        radius: 33,
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(40),
                          child: CachedNetworkImage(
                            imageUrl: widget.project.farmerMaster!.photo ?? '',
                            errorWidget: (_, __, ___) {
                              return Image.asset(
                                Images.sampleUser,
                                fit: BoxFit.cover,
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(widget.project.farmerMaster!.name ?? '',
                            style: figtreeMedium.copyWith(
                                fontSize: 16, color: Colors.black)),
                        10.verticalSpace(),
                        Row(
                          ...
                          children: [
                            ...
                            Text(widget.project.farmerMaster!.phone ?? '',
                                style: figtreeRegular.copyWith(
                                    fontSize: 12, color: Colors.black)),
                          ],
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: MediaQuery.of(context).size.width *
                                  0.5,
                              child: Text(widget.project.farmerMaster!.address!=null?
                              widget.project.farmerMaster!.address!.address!=null ?widget.project.farmerMaster!.address!.address!.toString():"":"",
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: figtreeRegular.copyWith(
                                  fontSize: 12,
      ...
      child: Stack(
        children: [
          PinCodeTextField(
            ...
            onChanged: (value) {
              if(value.length == 4){
                BlocProvider.of<ProjectCubit>(context).inviteExpertForSurvey(context,
                    widget.project.id,
                    '',
                    controller.text ?? '',
                    'hold', widget.project.farmerId.toString());
              }

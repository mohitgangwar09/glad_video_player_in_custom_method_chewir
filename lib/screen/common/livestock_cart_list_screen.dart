...
//                         getCurrencyString(int.parse(state.responseLivestockCartList!.data![0].cowQty.toString()) * double.parse(state.responseLivestockCartList!.data![0].cowPrice.toString()).toInt()).textSemiBold(color: Colors.black, fontSize: 20)
//                       ],
//                     ),
//                     40.verticalSpace(),
//                     Align(

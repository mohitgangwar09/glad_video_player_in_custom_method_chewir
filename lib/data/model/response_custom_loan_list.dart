class ResponseCustomLoanList {
  String? message;
  int? status;
  List<Data>? data;

  ResponseCustomLoanList({this.message, this.status, this.data});

  ResponseCustomLoanList.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  dynamic dailyTargetProductionValue;
  ...
  Data(
      {this.id,
        ...
        this.dailyTargetProductionValue,
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    dailyTargetProductionValue = json['daily_target_production_value'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['daily_target_production_value'] = dailyTargetProductionValue;

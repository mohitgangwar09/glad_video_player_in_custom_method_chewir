...
part of 'cowsandyielddonecubit.dart';

enum CowsAndCubitStatus { initial, loading, success, error }

class CowsAndCubitDoneState extends Equatable {
  ...
  factory CowsAndCubitDoneState.initial(){
    return CowsAndCubitDoneState(
  ...
  CowsAndCubitDoneState copyWith({

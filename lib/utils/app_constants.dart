class AppConstants {
  static const String baseUrl = 'https://uat-glad.staqo.com';
  ...
  static const String faqCategoryApi = '/api/faq/faq-category';
  static const String guestTrainingCategoryApi = '/api/training/guest-category';
  static const String guestFaqCategoryApi = '/api/faq-category';
  ...
  static const String farmerRepaymentMonthsApi = '/api/farmer-project/farmer-repayment-months-update';
  ...
  static const String guestLivestockListApi = '/api/live-stock/list-data';
  static const String livestockDetailApi = '/api/live-stock/cow-detail';
  static const String guestLivestockDetailApi = '/api/live-stock/details';
  ...
  static const String faqGuestApi = '/api/faq/faq-list';
  ...
  static const String loanCalculationApi = '/api/loan/loan-calculation';
